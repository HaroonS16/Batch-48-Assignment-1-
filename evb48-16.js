...
*/
var favPlaces = ["DUBAI", "ABU DHABI", "RIYADH", "MADINAH", "ISTANBUL", "DOHA"];
/*console.log('My favourite places I would love to visit are: ',favPlaces);// printed in original order*/
var favPlacesA = favPlaces.map(function (item) { return item; }); // using .map() to copy items from original array to this array(favPlacesA)
...
var favPlacesRA = favPlacesA.map(function (item) { return item; });
